...
$(function() {
    ...
    var info = [
        ...
        {
        questionTitle: '2. Какого типа данных нет в javascript?',
        questionText: ['Boolean', 'Decimal', 'String'],
        questionAnswer: ['false', 'true', 'false']
        },

        {
        questionTitle: '3. Что такое шаблонизация?',
        questionText: ['Это прием в веб дизайне', 'Это генерирование HTML на основании некоторых данных - “шаблона”', 'Это возможность сохранить данные в удобный формат'],
        questionAnswer: ['false', 'true', 'false']
        }
    ];
    ...
    $('.button-refer').on('click', function() {
        ...
        } else if ((markPositive >= 1) && (markPositive < 3)) {
